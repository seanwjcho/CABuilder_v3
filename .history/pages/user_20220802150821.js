...
function App() {
  ...
  return (
    ...
    <div className="App" text-align="center">
      ...
      <button onClick={renderPrompts}>Once you have selected a program, please press this button to see the available prompts.</button>
      ...
      <select onChange={handlePromptidChange}>
        ...
        {displayprompts?.map((prompt) => <option key={prompt.prompt_text} value={prompt.prompt_id}> {prompt.prompt_text} </option>)}
      </select>
