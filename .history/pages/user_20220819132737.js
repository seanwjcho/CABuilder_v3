      ...
      <div className="grid">
            ...
            <a className="card">
              ...
              <option value = "Select a tokenized prompt!"> -- Select a tokenized prompt -- </option>
                <br></br>
                {tokenizedpromptdisplay?.map((prompt) => <option key={prompt.prompt_text} value={prompt.prompt_id}> {prompt.prompt_text} </option>)}
              </select>
              </center>
              <br></br>
              <button className = "button2" onClick = {getResponse}>Once you have selected a tokenized prompt, please press this.</button>
            </a> 
