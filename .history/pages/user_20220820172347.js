    ...
    <div className="Container">
      ...
      <div className="grid">
            ...
            <a className="card">
              ...
              <br></br>
              <button className = "button2" onClick = {getTokens}>Once you have selected a tokenized prompt, please press this.</button>

              <button className = "button2" onClick = {getTokenizedResponse}>Once you have selected a tokenized prompt, please press this.</button>
            </a> 
